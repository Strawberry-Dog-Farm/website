...
<button class="ml-onclick-form" onclick="ml('show', 'uByRaX', true)">Click here to show form</button>
<a class="ml-onclick-form" href="javascript:void(0)" onclick="ml('show', 'uByRaX', true)">Click here to show form</a>
...
<script>
    ...
    ml('account', '1353404', { autoshow: false });
</script>
